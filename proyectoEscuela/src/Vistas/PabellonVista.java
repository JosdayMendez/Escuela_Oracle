 ...
 * @author Fabiola Mora
 */
public class PabellonVista extends javax.swing.JFrame {
    
    private PabellonBO aBO = new PabellonBO();

    /**
     * Creates new form Pabellon
     */
    public PabellonVista() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(Descripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(64, 241, -1, -1));
        ...
        jPanel1.add(txtDescripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(177, 235, 179, 36));

        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/escuela (3).png"))); // NOI18N
...
this.setVisible(false);
    ...
    private void AgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AgregarActionPerformed
        ...
        if (txtDescripcion.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Agregue la descripcion");
        } else {

            Pabellon a = new Pabellon();

            a.setID_PABELLON(Integer.parseInt(txtID.getText()));
            a.setDESCRIPCION(txtDescripcion.getText());
           

            String mensaje = aBO.agregarPabellon(a);
        }
    ...
    private void ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        ...
        if (txtDescripcion.getText().isEmpty()) {
            ...
            String mensaje = aBO.ModificarPabellon(a);
        }
    ...
    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        ...
        if (txtID.getText().isEmpty()) {
            ...
            String mensaje = aBO.eliminarPabellon(Integer.parseInt(txtID.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PabellonVista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PabellonVista().setVisible(true);
            }
        });
    }
