 ...
 * @author Fabiola Mora
 */
public class PadreVista extends javax.swing.JFrame {

    private PadreBO aBO = new PadreBO();
    /**
...
this.setVisible(false);
    ...
    private void AgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AgregarActionPerformed
        ...
        if (txtNombre.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Agregue el nombre del padre");
        }else {

            Padre a = new Padre();

            a.setID_PADRE(Integer.parseInt(txtID.getText()));
            a.setID_PROVINCIA(Integer.parseInt(txtIDProvincia.getText()));
            a.setNOMBRE_PADRE(txtNombre.getText());
            a.setAPELLIDO_PADRE1(txtApellido1.getText());
            a.setAPELLIDO_PADRE2(txtApellido2.getText());
            a.setTELEFONO_CONTACTO(txtTelefono.getText());
            a.setCORREO_PADRE(txtCorreo.getText());

            String mensaje = aBO.agregarPadre(a);
        }
    ...
    private void ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        ...
        if (txtNombre.getText().isEmpty()) {
            ...
            String mensaje = aBO.ModificarPadre(a);
        }
    ...
    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        ...
        if (txtID.getText().isEmpty()) {
            ...
            String mensaje = aBO.eliminarPadre(Integer.parseInt(txtID.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PadreVista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PadreVista().setVisible(true);
            }
        });
    }
