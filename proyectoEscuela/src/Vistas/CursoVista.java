...
public class CursoVista extends javax.swing.JFrame {
    ...
    private CursoBO aBO = new CursoBO();
    ...
    private void initComponents() {
        ...
        IDProfesor = new javax.swing.JLabel();
        ...
        Curso.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        Curso.setText("Curso");
        jPanel1.add(Curso, new org.netbeans.lib.awtextra.AbsoluteConstraints(64, 241, -1, -1));
        ...
        IDProfesor.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        IDProfesor.setText("ID Profesor");
        jPanel1.add(IDProfesor, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 320, -1, -1));
        jPanel1.add(txtCurso, new org.netbeans.lib.awtextra.AbsoluteConstraints(177, 235, 179, 36));
        jPanel1.add(txtIDProfesor, new org.netbeans.lib.awtextra.AbsoluteConstraints(177, 314, 179, 36));

        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/curso.png"))); // NOI18N
    ...
    private void AgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AgregarActionPerformed
        ...
        if (txtCurso.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Agregue el curso");
        }
        if (txtIDProfesor.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Agregue el ID profesor");
        } else {

            Curso a = new Curso();

            a.setID_CURSO(Integer.parseInt(txtID.getText()));
            a.setCURSO(txtCurso.getText());
            a.setID_PROFESOR(Integer.parseInt(txtIDProfesor.getText()));

            String mensaje = aBO.agregarCurso(a);
        }
    ...
    private void ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        ...
        if (txtIDProfesor.getText().isEmpty()) {
            ...
            a.setID_CURSO(Integer.parseInt(txtID.getText()));
            a.setID_CURSO(Integer.parseInt(txtCurso.getText()));
            a.setID_PROFESOR(Integer.parseInt(txtIDProfesor.getText()));

            String mensaje = aBO.ModificarCurso(a);
        }
    ...
    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        ...
        if (txtID.getText().isEmpty()) {
            ...
            String mensaje = aBO.eliminarCurso(Integer.parseInt(txtID.getText()));
    ...
    private javax.swing.JLabel IDProfesor;
