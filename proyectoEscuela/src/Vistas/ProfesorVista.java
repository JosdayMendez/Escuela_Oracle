...
public class ProfesorVista extends javax.swing.JFrame {
    ...
    private ProfesorBO aBO = new ProfesorBO();
    /**
    ...
    private void initComponents() {
        ...
        jPanel1.add(IDProvincia, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 410, -1, -1));
    ...
    private void AgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AgregarActionPerformed
        ...
        if (txtNombre.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Agregue el nombre del profesor");
        }else {

            Profesor a = new Profesor();

            a.setID_PROFESOR(Integer.parseInt(txtID.getText()));
            ...
            String mensaje = aBO.agregarProfesor(a);
        }
    ...
    private void ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        ...
        if (txtNombre.getText().isEmpty()) {
            ...
            String mensaje = aBO.ModificarProfesor(a);
        }
    ...
    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        ...
        if (txtID.getText().isEmpty()) {
            ...
            String mensaje = aBO.eliminarProfesor(Integer.parseInt(txtID.getText()));
